...
///
/// Uses the container `format.duration` field. Suitable for video and audio
/// files; images typically have no useful duration (callers should use the
/// project photo default instead).
